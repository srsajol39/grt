...
class General_Insurance_Agency_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function general_insurance_agency_loadClassLoader($class)
    {
    ...
    public static function general_insurance_agency_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
