...
class General_Insurance_Agency_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function general_insurance_agency_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function general_insurance_agency_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function general_insurance_agency_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function general_insurance_agency_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->general_insurance_agency_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function general_insurance_agency_load( $class ) {
